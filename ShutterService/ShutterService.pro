...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../ShutterController/release/ -lShutterController
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../ShutterController/debug/ -lShutterController
else:unix: LIBS += -L$$OUT_PWD/../ShutterController/ -lShutterController

INCLUDEPATH += $$PWD/../ShutterController
DEPENDPATH += $$PWD/../ShutterController
