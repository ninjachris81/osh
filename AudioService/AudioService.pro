...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../AudioController/release/ -lAudioController
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../AudioController/debug/ -lAudioController
else:unix: LIBS += -L$$OUT_PWD/../AudioController/ -lAudioController

INCLUDEPATH += $$PWD/../AudioController
DEPENDPATH += $$PWD/../AudioController

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../AudioController/release/libAudioController.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../AudioController/debug/libAudioController.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../AudioController/release/AudioController.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../AudioController/debug/AudioController.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../AudioController/libAudioController.a
