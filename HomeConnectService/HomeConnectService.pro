...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../HomeConnectController/release/ -lHomeConnectController
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../HomeConnectController/debug/ -lHomeConnectController
else:unix: LIBS += -L$$OUT_PWD/../HomeConnectController/ -lHomeConnectController

INCLUDEPATH += $$PWD/../HomeConnectController
DEPENDPATH += $$PWD/../HomeConnectController
