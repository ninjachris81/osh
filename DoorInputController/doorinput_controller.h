#ifndef DOORINPUT_CONTROLLER_H
#define DOORINPUT_CONTROLLER_H
...
class SHARED_LIB_EXPORT DoorInputController : public ControllerBase
{
    Q_OBJECT
public:
    explicit DoorInputController(ControllerManager* manager, QString id, QObject *parent = nullptr);
