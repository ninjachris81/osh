...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../OBISController/release/ -lOBISController
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../OBISController/debug/ -lOBISController
else:unix: LIBS += -L$$OUT_PWD/../OBISController/ -lOBISController

INCLUDEPATH += $$PWD/../OBISController
DEPENDPATH += $$PWD/../OBISController
