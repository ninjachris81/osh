...
QVariant NativeProcessorTask::run() {
    ...
    if (checkRunCondition()) {
        ...
        case NFT_APPLY_SHUTTER_LOGIC_ADV:
            m_lastResult = m_advScripts->applyShutterLogic(m_nativeParams.at(0).toString(), m_nativeParams.at(1).toString(), m_nativeParams.at(2).toString(), m_nativeParams.at(3).toDouble(), m_nativeParams.at(4).toDouble(), m_nativeParams.at(5).toInt(), m_nativeParams.at(6).toInt(), m_nativeParams.at(7).toInt(), m_nativeParams.at(8).toString(), m_nativeParams.at(9).toDouble(), m_nativeParams.at(10).toDouble(), m_nativeParams.at(11).toString(), m_nativeParams.at(12).toString(), m_nativeParams.at(13).toString(), m_nativeParams.at(14).toString());
            break;
        ...
        case NFT_INIT_FOLLOW_ACTOR:
            ...
            break;
        case NFT_START_TIMER:
            m_lastResult = m_basicScripts->startTimer(m_nativeParams.at(0).toString());
            break;
        case NFT_STOP_TIMER:
            m_lastResult = m_basicScripts->stopTimer(m_nativeParams.at(0).toString());
            break;
        default:
...
QList<QVariant::Type> NativeProcessorTask::paramTypeList(NativeProcessorTask::NativeFunctionType nativeFunction) {
    ...
    case NativeProcessorTask::NFT_APPLY_SHUTTER_LOGIC_ADV:
        return QList<QVariant::Type>() << QVariant::String << QVariant::String << QVariant::String << QVariant::Double << QVariant::Double << QVariant::Int << QVariant::Int << QVariant::Int << QVariant::String << QVariant::Double << QVariant::Double << QVariant::String << QVariant::String << QVariant::String << QVariant::String;
