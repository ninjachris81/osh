...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../DoorCameraController/release/ -lDoorCameraController
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../DoorCameraController/debug/ -lDoorCameraController
else:unix: LIBS += -L$$OUT_PWD/../DoorCameraController/ -lDoorCameraController

INCLUDEPATH += $$PWD/../DoorCameraController
DEPENDPATH += $$PWD/../DoorCameraController
