...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../USBInputController/release/ -lRS232InputController
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../RS232InputController/debug/ -lRS232InputController
else:unix: LIBS += -L$$OUT_PWD/../RS232InputController/ -lRS232InputController

INCLUDEPATH += $$PWD/../RS232InputController
DEPENDPATH += $$PWD/../RS232InputController
